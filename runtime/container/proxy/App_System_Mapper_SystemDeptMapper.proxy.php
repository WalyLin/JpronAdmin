...
class SystemDeptMapper extends AbstractMapper
{
    ...
    public function addLeader(int $id, array $users) : bool
    {
        ...
        return self::__proxyCall(__CLASS__, __FUNCTION__, ['order' => ['id', 'users'], 'keys' => compact(['id', 'users']), 'variadic' => ''], function (int $id, array $users) use($__function__, $__method__) {
    ...
    public function batchUpdate(array $update) : bool
    {
        $__function__ = __FUNCTION__;
        $__method__ = __METHOD__;
        return self::__proxyCall(__CLASS__, __FUNCTION__, ['order' => ['update'], 'keys' => compact(['update']), 'variadic' => ''], function (array $update) use($__function__, $__method__) {
