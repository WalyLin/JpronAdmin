...
class MineModel extends Model
{
    ...
    public function save(array $options = []) : bool
    {
        ...
        return self::__proxyCall(__CLASS__, __FUNCTION__, ['order' => ['options'], 'keys' => compact(['options']), 'variadic' => ''], function (array $options = []) use($__function__, $__method__) {
    ...
    public function update(array $attributes = [], array $options = []) : bool
    {
        $__function__ = __FUNCTION__;
        $__method__ = __METHOD__;
        return self::__proxyCall(__CLASS__, __FUNCTION__, ['order' => ['attributes', 'options'], 'keys' => compact(['attributes', 'options']), 'variadic' => ''], function (array $attributes = [], array $options = []) use($__function__, $__method__) {
