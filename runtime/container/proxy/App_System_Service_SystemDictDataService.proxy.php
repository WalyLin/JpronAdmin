...
class SystemDictDataService extends AbstractService implements DictDataServiceInterface
{
    ...
    public function getList(?array $params = null, bool $isScope = false) : array
    {
        ...
        return self::__proxyCall(__CLASS__, __FUNCTION__, ['order' => ['params', 'isScope'], 'keys' => compact(['params', 'isScope']), 'variadic' => ''], function (?array $params = null, bool $isScope = false) use($__function__, $__method__) {
            $args = ['select' => ['id', 'label as title', 'value as key'], 'status' => MineModel::ENABLE, 'orderBy' => 'sort', 'orderType' => 'desc'];
