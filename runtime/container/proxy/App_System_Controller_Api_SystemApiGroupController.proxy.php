...
class SystemApiGroupController extends MineController
{
    ...
    public function save(SystemApiGroupRequest $request) : ResponseInterface
    {
        $__function__ = __FUNCTION__;
        $__method__ = __METHOD__;
        return self::__proxyCall(__CLASS__, __FUNCTION__, ['order' => ['request'], 'keys' => compact(['request']), 'variadic' => ''], function (SystemApiGroupRequest $request) use($__function__, $__method__) {
    ...
    public function update(int $id, SystemApiGroupRequest $request) : ResponseInterface
    {
        $__function__ = __FUNCTION__;
        $__method__ = __METHOD__;
        return self::__proxyCall(__CLASS__, __FUNCTION__, ['order' => ['id', 'request'], 'keys' => compact(['id', 'request']), 'variadic' => ''], function (int $id, SystemApiGroupRequest $request) use($__function__, $__method__) {
