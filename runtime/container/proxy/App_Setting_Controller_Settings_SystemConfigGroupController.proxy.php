...
class SystemConfigGroupController extends MineController
{
    ...
    public function save(SettingConfigGroupRequest $request) : ResponseInterface
    {
        $__function__ = __FUNCTION__;
        $__method__ = __METHOD__;
        return self::__proxyCall(__CLASS__, __FUNCTION__, ['order' => ['request'], 'keys' => compact(['request']), 'variadic' => ''], function (SettingConfigGroupRequest $request) use($__function__, $__method__) {
