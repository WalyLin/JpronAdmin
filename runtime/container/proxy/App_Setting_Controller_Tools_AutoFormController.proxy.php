...
class AutoFormController extends MineController
{
    ...
    public function table(mixed $table_id)
    {
        ...
        return self::__proxyCall(__CLASS__, __FUNCTION__, ['order' => ['table_id'], 'keys' => compact(['table_id']), 'variadic' => ''], function (mixed $table_id) use($__function__, $__method__) {
    ...
    public function index($table_id) : ResponseInterface
    {
        $__function__ = __FUNCTION__;
        $__method__ = __METHOD__;
        return self::__proxyCall(__CLASS__, __FUNCTION__, ['order' => ['table_id'], 'keys' => compact(['table_id']), 'variadic' => ''], function ($table_id) use($__function__, $__method__) {
            $table = $this->tablesService->read($table_id);
            if (empty($table)) {
                return $this->error('没找到此表, 请检查表id');
            }
    ...
    public function update(mixed $table_id, mixed $id) : ResponseInterface
    {
        $__function__ = __FUNCTION__;
        $__method__ = __METHOD__;
        return self::__proxyCall(__CLASS__, __FUNCTION__, ['order' => ['table_id', 'id'], 'keys' => compact(['table_id', 'id']), 'variadic' => ''], function (mixed $table_id, mixed $id) use($__function__, $__method__) {
    ...
    public function read(mixed $table_id, int $id) : ResponseInterface
    {
        $__function__ = __FUNCTION__;
        $__method__ = __METHOD__;
        return self::__proxyCall(__CLASS__, __FUNCTION__, ['order' => ['table_id', 'id'], 'keys' => compact(['table_id', 'id']), 'variadic' => ''], function (mixed $table_id, int $id) use($__function__, $__method__) {
    ...
    public function changeStatus($table_id) : ResponseInterface
    {
        ...
        $__method__ = __METHOD__;
        return self::__proxyCall(__CLASS__, __FUNCTION__, ['order' => ['table_id'], 'keys' => compact(['table_id']), 'variadic' => ''], function ($table_id) use($__function__, $__method__) {
            return $this->service->changeStatus($table_id, (int) $this->request->input('id'), (string) $this->request->input('statusValue'), (string) $this->request->input('statusName', 'status')) ? $this->success() : $this->error();
        });
    }
    /**
     * 回收站角色分页列表.
