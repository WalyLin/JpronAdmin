...
class ApiDocController extends MineApi
{
    ...
    function __construct(\Mine\MineRequest $request, \Mine\MineResponse $response)
    {
    ...
    public function getAppAndInterfaceList(string $id) : ResponseInterface
    {
        ...
        return self::__proxyCall(__CLASS__, __FUNCTION__, ['order' => ['id'], 'keys' => compact(['id']), 'variadic' => ''], function (string $id) use($__function__, $__method__) {
